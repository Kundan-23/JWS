...
export const useConfigStore = create(
  persist(
    (set) => ({
      ...
      // Text & Policies
      registrationTerms: "By completing this registration, you agree to abide by the rules and regulations of JWS 2026...",
