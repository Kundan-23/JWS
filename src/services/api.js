...
export const playerAPI = {
  ...
  uploadAadharFront:  (file)   => { const f = new FormData(); f.append('file', file); return API.post('/player/upload/aadhar-front', f, { headers: { 'Content-Type': 'multipart/form-data' } }); },
  uploadAadharBack:   (file)   => { const f = new FormData(); f.append('file', file); return API.post('/player/upload/aadhar-back',  f, { headers: { 'Content-Type': 'multipart/form-data' } }); },
  unlockDashboard:    ()       => API.post('/player/unlock-dashboard'),
