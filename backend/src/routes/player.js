...
router.post('/upload/aadhar-front',  upload.single('file'), playerController.uploadAadharFront);
router.post('/upload/aadhar-back',   upload.single('file'), playerController.uploadAadharBack);
router.get('/matches',                          playerController.getMatches);
router.get('/id-card',                          playerController.downloadIdCard);
router.post('/unlock-dashboard',                playerController.unlockDashboard);
// Match Bookings
